   ...
   public partial class AboutBox1 : Form
    {
        ...
        { 
            ...
            this.labelProductName.Text = "Ürün Adı : " + AssemblyProduct;
            this.labelVersion.Text = String.Format("Sürüm : {0}", AssemblyVersion);
            this.labelChrome.Text = "Chrome Sürüm : " + chromiumVersion; ;
            this.labelCompanyName.Text = "Şirket Adı : "+ AssemblyCompany;
